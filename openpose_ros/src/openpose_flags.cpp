...
// OpenPose
DEFINE_string(model_folder,             "/home/link/os/openpose/models/",      "Folder path (absolute or relative) where the models (pose, face, ...) are located.");
...
DEFINE_string(net_resolution,           "256x-1",       "Multiples of 16. If it is increased, the accuracy potentially increases. If it is"
